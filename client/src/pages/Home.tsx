  ...
  return (
    <Box>
      ...
      <Box mt="20px" display='flex' flexWrap="wrap" gap={4}>
        ...
        <PieChart title="Properties for Rent" value={550} series={[60,40]} colors={['#475ae8','#e4e8ef']}/>
        <PieChart title="Total Customers" value={5684} series={[75,25]} colors={['#275be8','#c4e8ef']}/>
        <PieChart title="Properties for cities" value={666} series={[75,25]} colors={['#175be8','#e4d8ef']}/>
      </Box>
